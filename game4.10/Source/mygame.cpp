...
void CGameStateInit::OnInit()
{
	...
	option.push_back("VOLUME");
	option.push_back("LEFT");
	option.push_back("DOWN");
	option.push_back("RIGHT");
	option.push_back("JUMP");
	option.push_back("SPACE");
	option.push_back("RUN");
	option.push_back("CAN MOVE BACKWARD TRUE");
